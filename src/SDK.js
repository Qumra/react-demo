...
//# sourceMappingURL=axios.min.map/**全局使用，每次发送请求之前增加token */
...
(function(root, factory) {
     ...
     * }
     */
    function SMCSDK(config) {

        this.util = new SMCSDK_Util();
        this.config = config;
        if (!config["sdkServerUrl"]) {
            this.util.log({ "logLevel": "error", "logMsg": "sdkServerUrl is invalid" });
        }
        this.user = {};
        this.user.auth = new SMCSDK_User_Auth();
        this.user.account = new SMCSDK_User_Account();
        //this.user.event = new SMCSDK_User_Event();
        //this.user.conference = new SMCSDK_User_Conf();
        //this.user.wesocket = new SMCSDK_User_WebSocket();
        //this.user.config = new SMCSDK_User_Device();
        //TO add more here
        this.userInfo = {
            "session": "",
        };
    ...
    SMCSDK.prototype.getSdkServerUrl = function() {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        // Browser globals (root is window)
        root.SMCSDK_User_Account = factory();
    }
}(this, function() {
    function SMCSDK_User_Account() { };
     ...
     * }
     */
    SMCSDK_User_Account.prototype.addAccount = function(param) {
        if (undefined == param) {
    ...
    SMCSDK_User_Account.prototype.modifyAccount=function(param){
     ...
     * }
     */
    SMCSDK_User_Account.prototype.removeAccount=function(param){
     ...
     * }
     */
    SMCSDK_User_Account.prototype.resetPassword=function(param){

    }



    return SMCSDK_User_Account;
}));(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define([], factory);
        ...
        // Browser globals (root is window)
        root.SMCSDK_User_Auth = factory();
    }
}(this, function () {
    function SMCSDK_User_Auth() { };
     ...
     * }
     */
    SMCSDK_User_Auth.prototype.login = function (param) {
        if (undefined == param) {
            huaweiSMCSDK.util.log({ "logLevel": "error", "logMsg": "param is invalid" });
            return;
        }
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        // Browser globals (root is window)
        root.SMCSDK_Util = factory();
    }
}(this, function() {
    function SMCSDK_Util() {};
     ...
     * }
     */
    SMCSDK_Util.prototype.log = function(logParam) {
     ...
     * }
     */
    SMCSDK_Util.prototype.preProcessData = function(cfg) {
        var settings = {};
     ...
     * @param param 
     */
    SMCSDK_Util.prototype.isNumber = function(param) {
        if (undefined == param) {
            return false;
        }
        var regex = /^[1-9]+[0-9]*]*$/;
     ...
     * @param isdn
     */
    SMCSDK_Util.prototype.checkIsdn = function(isdn) {
     ...
     * @param ip
     */
    SMCSDK_Util.prototype.checkIp = function(ip) {
        if (undefined == ip) {
            return false;
        }
